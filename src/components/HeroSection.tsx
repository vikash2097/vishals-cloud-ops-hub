  ...
  return (
    <section id="hero" className="relative min-h-screen pt-36 pb-20 elegant-dark overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-2/3 h-full bg-gradient-to-l from-elegant-800/10 to-transparent"></div>
        <div className="absolute bottom-0 left-0 w-2/3 h-1/2 bg-gradient-to-t from-elegant-900/20 to-transparent"></div>
        <div className="absolute top-20 left-[10%] w-72 h-72 bg-rich-800/20 rounded-full mix-blend-multiply filter blur-3xl"></div>
        <div className="absolute bottom-20 right-[10%] w-96 h-96 bg-elegant-800/20 rounded-full mix-blend-multiply filter blur-3xl"></div>
      </div>
      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block animate-fade-in">
            <span className="inline-flex items-center rounded-full border border-elegant-300/20 bg-elegant-900/50 px-4 py-1.5 text-sm font-medium text-elegant-100 backdrop-blur-sm">
              Available for new clients
            </span>
          </div>
          
          <h1 className="mb-10 animate-slide-down">
            <span className="block font-serif text-elegant-50 mb-3 font-light">Solutions Architect &</span>
            <span className="gradient-text font-serif">DevOps Expert</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-elegant-200 mb-12 max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center animate-fade-in" style={{ animationDelay: "0.3s" }}>
            <a href="#contact" className="bg-rich-700 hover:bg-rich-800 text-elegant-50 text-base px-8 py-3.5 flex items-center gap-2 shadow-elegant rounded-md transition-all">
              Let's Work Together <ArrowRight className="w-5 h-5" />
            </a>
            <a href="#services" className="border border-elegant-700 text-elegant-100 bg-elegant-800/30 hover:bg-elegant-800/50 backdrop-blur-sm text-base px-8 py-3.5 rounded-md hover:shadow-sm transition-all">
              Explore Services
            </a>
          </div>
